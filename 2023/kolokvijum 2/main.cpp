...
int main() {
	int maxPodataka = 10, brojPodataka = 5;
	...
	{
		cerr << "Greska pri radu sa kolekcijom float-ova: " << error << endl;
	}
	...
	{
		cerr << "Greska pri radu sa kolekcijom ProsirenihPodataka: " << error << endl;
	}
